...
| NW-007 | Manuelle Reservierungswarnungen und Stornierung | P2 - Lager & Fulfillment | done | docs/spec.md GR-02, W-2 | Warnfristen fuer Neukunden und Stammkunden; nach Frist kann ein Admin unbezahlte Bestellungen manuell stornieren und die voruebergehende Lagerreservierung freigeben. Keine automatische Stornierung. |
