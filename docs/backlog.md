...
| NW-018 | Abo-Box-Verwaltung | P3 - Regeln & Automatisierung | validated | docs/spec.md Entitaet Abo-Box, GR-16 | Statuswerte sind geklaert: aktiv, pausiert, gekuendigt. Inhalt ist die monatliche globale Auswahl von genau vier mit `In Abo-Box enthalten` markierten Produkten. |
| NW-019 | Monatliche Abo-Abwicklung | P3 - Regeln & Automatisierung | validated | docs/spec.md GR-14, GR-16 | Sammelabwicklung am 15. mit Versandlabeln, konsolidierter Packliste und Lagerabbuchung fuer die vier monatlich markierten Abo-Produkte. |
