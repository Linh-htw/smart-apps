...
| `Spec.md` | Fachliche Produkt-Spec im Repo-Root, ersetzt PRD | Aktualisieren bei Scope- oder Regel-Aenderungen. |
...
- `docs/prd.md`, weil `Spec.md` diese Rolle uebernimmt.
...
1. **Kontext laden:** `AGENTS.md`, dann `Spec.md`, bei Umsetzung auch `docs/architecture.md` und `docs/backlog.md`.
...
```text
Spec.md -> docs/backlog.md -> docs/concepts/ optional -> Implementation -> docs/decisions.md bei Entscheidung
```

`Spec.md` beschreibt Was und Warum. `docs/backlog.md` macht daraus stabile, referenzierbare Feature-IDs. `docs/architecture.md` beschreibt Wie. `docs/decisions.md` erklaert Warum bei Entscheidungen.

## Entscheidungsregeln

- Fachliche Regeln aus `Spec.md` haben Vorrang vor Annahmen.
